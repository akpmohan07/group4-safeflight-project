...
INSERT INTO flight_schedule (id, flight_id, route_id, travel_date, travel_time) VALUES
  ...
  (2, 1, 1, '2026-06-01', '14:00:00'),
  (3, 1, 1, '2026-06-02', '08:30:00'),
  (4, 2, 2, '2026-06-01', '10:00:00'),
  (5, 2, 2, '2026-06-02', '18:45:00'),
...
INSERT INTO booking (id, user_id, flight_schedule_id, status, payment_status, booked_time) VALUES
  (1, 1, 1, 'CONFIRMED', 'SUCCESS', '2026-05-01 10:00:00')
ON CONFLICT (id) DO NOTHING;
